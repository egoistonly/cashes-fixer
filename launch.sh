...
RDP_IP="192.168.82.66"  # IP Сервера RDP, например "172.29.21.25"
RDP_PORT="3389" # Если не стандартный порт, изменить на нужный
RDP_DOMAIN="kmki.ru" # Домен Windows
RDP_USER="" # Логин
...
CHROME_ADDRESS="https://srv-l8.asm-s.com/TbAdi6F1Tm7melimVpPF/ https://b24.asm-s.com" # например "ya.ru" или две вкладки "ya.ru google.ru"
